function cm_data = cividis(m)

% cividis  Perceptually uniform colormap (blue-yellow)
%
% Syntax
%   cm_data = cividis();
%   cm_data = cividis(m);
%
% Description
%   cm_data = cividis() creates a perceptually uniform, blue-yellow
%   colormap.
% 
%   cm_data = cividis(m) creates the colormap and interpolates the colours
%   across m values.
% 
%   Perceptually uniform colormaps are important to allow the displayed
%   data to be interpreted equally well by people with colour vision
%   deficiencies (sometimes referred to as colour blindness). This colormap
%   spans blue and yellow. Other perceptually uniform colormaps are
%   available using different colour schemes. 
%
%   The specific colour scheme represented here is the result of work by
%   Jamie R. Nuñez, Christopher R. Anderton, Ryan S. Renslow, published as
